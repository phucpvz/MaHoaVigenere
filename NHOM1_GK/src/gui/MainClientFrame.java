...
public class MainClientFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Địa chỉ IP Server");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtServerAddress, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConnectActionPerformed
        ...
        try {
            if (txtServerAddress.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Bạn phải nhập địa chỉ server!");
                return;
            }
            if (!txtServerAddress.getText().matches("^([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})$") && !txtServerAddress.getText().equals("localhost")){
                JOptionPane.showMessageDialog(null, "Bạn nhập địa chỉ server không hợp lệ!");
                return;
            }
            if (txtPort.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Bạn phải nhập cổng server!");
                return;
            }
            
            int port = Integer.parseInt(txtPort.getText());
            if (port < 0 || port > 65535) {
                JOptionPane.showMessageDialog(null, "Cổng phải nằm trong phạm vi từ 0 đến 65535!");
                return;
            }
            
            this.client = new Client(txtServerAddress.getText(), Integer.parseInt(txtPort.getText()));
            this.client.sendData("test");
            String response = this.client.revData();
            if(response.equals("success")){
                MainFrame mainFrame = new MainFrame(this.client);
                mainFrame.setVisible(true);
            }
            else {
                JOptionPane.showMessageDialog(null, "Khổng kết nối được với server!");
                return;
            }
